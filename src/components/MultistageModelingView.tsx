      ...
      <div className="flex-1 lg:overflow-hidden">
        {viewMode === "config" ? (
          ...
          <div className="h-full flex flex-col gap-6 lg:overflow-y-auto pb-6">
            ...
            {/* 3. Income Shift Visualization (Moved directly under Long-Term Portfolio Projection) */}
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-4 flex flex-col gap-6 shadow-sm transition-colors shrink-0">
              <div>
                <h3 className="text-lg font-bold tracking-tight text-zinc-900 dark:text-zinc-50 mb-1">
            ...
            {/* 4. Actionable Strategy Ledger (Moved directly under Income Shift Visualization) */}
            {activeScenario?.bridgeOptimizationEnabled !== false && (
              <div className="flex flex-col gap-6 shrink-0">
                {bridgeLoading ? (
                  <div className="p-8 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl flex flex-col items-center justify-center text-zinc-500 min-h-[150px] transition-colors">
            ...
            {/* Required Minimum Distributions (RMDs) & Reinvestment */}
            ...
            {/* Bridge Period Optimization Chart */}
            {activeScenario?.bridgeOptimizationEnabled !== false && (
