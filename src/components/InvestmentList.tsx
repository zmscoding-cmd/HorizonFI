        ...
        return (
          <div key={asset.id} className="group relative bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow flex flex-col">
            <div className="flex justify-between items-start mb-3">
              <div className="pr-8">
                <h4 className="font-semibold text-zinc-900 dark:text-zinc-100 leading-tight truncate">{asset.name}</h4>
            ...
            <div className="mt-auto pt-4 flex flex-col gap-1">
              ...
              <div className="flex items-center gap-3 text-xs text-zinc-500 dark:text-zinc-400 mt-1">
                ...
                {((asset.expectedDividendYield ?? 0) > 0) && (
                  <span className="flex items-center gap-1 border-l border-zinc-200 dark:border-zinc-700 pl-3" title={`Dividend Yield (${asset.dividendReinvestment === 'payout' ? 'Payout' : 'DRIP'})`}>
            ...
            {/* Absolute positioned actions (reveal on hover / focus) */}
            <div className="absolute top-3 right-3 flex items-center gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
              <button
                ...
                className="p-1.5 text-zinc-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg transition-colors min-h-[36px] min-w-[36px] flex items-center justify-center"
              ...
              <button
                ...
                className="p-1.5 text-zinc-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors min-h-[36px] min-w-[36px] flex items-center justify-center"
